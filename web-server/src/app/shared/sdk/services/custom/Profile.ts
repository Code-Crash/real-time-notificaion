...
export class ProfileApi extends BaseLoopBackApi {
   ...
   *  - `result` – `{object}` - 
   */
  public verifyAccount(token: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Profiles/verifyAccount";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof token !== 'undefined' && token !== null) _urlParams.token = token;
   ...
   *  - `result` – `{object}` - 
   */
  public sendPasswordResetLink(email: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Profiles/sendPasswordResetLink";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   *  - `result` – `{object}` - 
   */
  public forgotPassword(token: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `result` – `{object}` - 
   */
  public sendToken(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Profiles/sendToken";
    let _routeParams: any = {};
   ...
   *  - `result` – `{object}` - 
   */
  public customResetPassword(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Profiles/customResetPassword";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof data !== 'undefined' && data !== null) _urlParams.data = data;
   ...
   *  - `result` – `{object}` - 
   */
  public verifyAccountByPIN(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Profiles/verifyAccountByPIN";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof data !== 'undefined' && data !== null) _urlParams.data = data;
  ...
  /**
   * @ngdoc method
   * @name sdk.Profile#getCurrent
   * @methodOf sdk.Profile
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Profiles" + "/:id";
   ...
   * call to {@link sdk.Profile#login} or
   * {@link sdk.Profile#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Profile#login}
   *
  ...
  /**
   * @name sdk.Profile#isAuthenticated
   *
